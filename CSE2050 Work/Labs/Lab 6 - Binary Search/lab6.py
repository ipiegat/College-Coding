class OrderedList:
    ...
    def _bs(self, target, min_index, max_index):
        ...
        if min_index > max_index:
            ...
            elif target == self[mid_index]:
                return True

            # item is in smaller half
            elif target < self[mid_index]:
                return self._bs(target, min_index, mid_index - 1)

            # item is in bigger half
            elif target > self[mid_index]:
                return self._bs(target, mid_index + 1, max_index)
