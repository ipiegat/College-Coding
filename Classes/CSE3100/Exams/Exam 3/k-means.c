...
void* thread_main(void* thread_arg) {
    ...
    // use compute labels/centroids functions on data 
...
int main(int argc, char *argv[])
{
    ...
    // point_t *best_centroids = arg->centroids;

    // tried using functions... didn't compile... "manually" doing it now
    double best_d = squared_intra_cluster_dist[0];
    point_t *best_centroids = centroids[0];

    // go through lists. smallest distance is best, if smaller distance found, overwrite
